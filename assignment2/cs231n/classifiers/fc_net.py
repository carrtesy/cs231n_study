...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3*32*32, hidden_dim=100, num_classes=10,
        ...
        std = weight_scale
        self.params['W1'] = std * np.random.randn(D, H) # D X H
        self.params['b1'] = np.zeros(H) # H, 1
        self.params['W2'] = std * np.random.randn(H, C) # H X C
        self.params['b2'] = np.zeros(C) # C, 1
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
    ...
    def loss(self, X, y=None):
        ...
        dx, grads['W2'], grads['b2'] = affine_backward(upstream, L2_cache)
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3*32*32, num_classes=10,
        ...
        pairs = [(dims[p], dims[p+1]) for p in range(len(dims) - 1)]
        std = weight_scale        
        layernum = 0    
